...
export default function MissionSection() {
  return (
    <section className="relative overflow-hidden px-6 py-20 sm:px-12 md:px-20 lg:px-32 bg-white">
      ...
      <div className="absolute top-[-150px] left-[-150px] w-[400px] h-[400px] bg-cyan-200 rounded-full blur-3xl opacity-20 z-0"></div>
      <div className="absolute bottom-[-150px] right-[-150px] w-[400px] h-[400px] bg-cyan-100 rounded-full blur-3xl opacity-20 z-0"></div>
      ...
      >
        ...
        <div className="text-center lg:text-left">
          <motion.div
            className="inline-block bg-gradient-to-tr from-cyan-400 to-cyan-600 p-6 rounded-full shadow-xl mb-6"
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
          ...
          <motion.div
            className="w-24 h-1 bg-cyan-500 mb-6 rounded-full mx-auto lg:mx-0"
            initial={{ scaleX: 0 }}
