  ...
  if (!course) return (
    <div className="max-w-2xl mx-auto p-6 text-center py-20">
      <div className="bg-red-100 text-red-700 p-4 rounded-lg mb-6">
        ...
        <p className="mt-2">The requested course doesn't exist or has been removed</p>
      </div>
      <button 
              ...
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div className="flex items-center text-yellow-500">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className={`w-5 h-5 ${i < (course.rating || 4) ? 'fill-current' : 'text-gray-300'}`} viewBox="0 0 24 24">
                        <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
                      </svg>
                    ))}
                    <span className="ml-2 text-gray-600">({course.reviews || 124})</span>
                  </div>
                </div>
