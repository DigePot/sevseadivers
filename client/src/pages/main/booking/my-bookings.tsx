    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="flex items-center mb-6 flex-wrap gap-2">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-cyan-700">
            My Bookings
          </h1>
        </div>
        ...
        {!isLoading && !error && bookings.length === 0 && (
          <div className="max-w-lg mx-auto text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              You haven't made any bookings yet. Start exploring our trips and
              courses!
            </p>
            <button
        ...
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {bookings.map((booking: Booking) => {
            ...
            const title =
              booking.Trip?.title || booking.Course?.title || "Booking"
            const description =
              booking.Trip?.description || booking.Course?.description || ""
              ...
              >
                {imageUrl ? (
                  <div className="relative">
                    ...
                    />
                    <span
                      className={`absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-bold ${statusStyle.bg} ${statusStyle.text} ${statusStyle.border}`}
                    >
                ...
                <h2 className="text-lg sm:text-xl font-semibold mb-2 text-cyan-700 line-clamp-1">
                  {title}
                </h2>
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  <div className="text-sm text-gray-500">{bookingDate}</div>
                </div>
